...
Well now, this certainly isn't looking too good. We can see that Beef & Pork, Breakfast, and Chicken & Fish category menu items easily break over 40 % of one's daily sodium intake. Likewise, they hover around 40 % of a person's daily intake of fat. Somewhat unsurprisingly, Smoothies & Shakes are also extremely high in sugar, averaging around 30% of one's daily recommended amount of sugar. Could it be that McDonald's fast food deserves its reputation as unhealthy, sugary, salty, fatty goodness? 
